---
title: "BEK: FPGA Based Processor for Image Downsampling (Coursework)"
...
date: 2020-01-01
---
![Project screenshot](/images/fpga_downsampling.jpg)
...
**Control Store:** The control signal of the BEK processor is 30 bits: the first 8 bits for next address, the next 4 bits for ALU operation, the next 10 bits for C bus operation, the next 3 bits for memory signals, the next 1 bit for PC increment, and the last 4 bits for B bus operation. The results were cross-checked with a simulation implemented in MATLAB.

I was involved in the design of the ISA.
Collaborative work.
